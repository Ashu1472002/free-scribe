...
export default function HomePage(props) {
    ...
    return(
        <div>
            <main className='flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pt-30 pb-20'>
                ...
                <button onClick={recordingStatus === 'recording' ? stopRecording : startRecording}    className='flex specialBtn px-4 py-2 rounded-xl item-center text-base justify-between gap-4 mx-auto w-72 max-w-full my-4'>
                ...
                <p className='text-base'>Or <label className='text-blue cursor-pointer hover:text-blue-600 duration-200'>Upload <input onChange={(e) => {
